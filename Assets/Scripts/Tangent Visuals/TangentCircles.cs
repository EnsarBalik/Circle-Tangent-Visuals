...
public class TangentCircles : CircleTangent
{
    ...
    void Update()
    {
        ...
        _innerCircleGo.transform.position = new Vector3(innerCircle.w, innerCircle.w, innerCircle.w) * 2;
        
        _outterCircleGo.transform.position = new Vector3(outerCircle.x, outerCircle.y, outerCircle.z);
        _outterCircleGo.transform.position = new Vector3(outerCircle.w, outerCircle.w, outerCircle.w) * 2;
    }
}